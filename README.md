# Emberlash-V2-by-LordMouse-gamesense-lua-
-- ========================================================================
-- =)
-- ========================================================================
...
local trash_talk do
    local phrases = {
        ...
        kill = {
            ...
            {'1', 1.0},
            {'zｚＺ', 0.4, 'playing with emberlash is so boooring', 1.2},
            {'im cursed', 0.4, 'satan is watching us', 0.9},
            {'family-friendly lua -> .gg/emberlash', 0.7},
            {'1', 1.0},
            {'1', 0.5, 'теперь думай кто это написал)))', 1.0},
            {'мы летим низко', 0.4, 'в бошке храню все emberlash', 1.0},
            {'снова палю в экран', 0.4, 'снова вижу этот дискорд', 0.6, '.gg/emberlash', 0.8},
            {'1', 0.4, 'иди ты нахуй дебилина', 1.2},
            {'1', 0.4, 'ФХАФЫХАЫХФАХ', 0.8, 'бомж ты куда', 0.8},
            {'моя сила emberlash', 0.7, 'что не брикаю лцшечку', 1.1},
            {'это происходит в действительности?', 0.5, '1', 1.0},
            {'я смотрю', 0.5, 'у тебя тренировка по удачному спаму пуль, продолжай', 1.0},
            {'если бы твой скилл зависел от интеллекта', 0.5, 'ты бы и в меню не зашёл', 1.0},
            {'ты не победил', 0.3, 'я просто протестировал баг на перерождение', 0.7},
            {'1', 1.0},
            {'где тебя научили стрелять', 0.2, 'в тире для первоклассников?', 0.9},
            {'z бы тебя похвалил', 0.2, 'но ты выиграл не скиллом', 0.5, 'а везением', 0.8},
            {'ты - как бесплатный emberlash', 0.2, 'который никто не скачивает', 0.8},
            {'1', 1.0},
